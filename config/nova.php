...
return [
    ...
    |
    */
    'license_key' => env('NOVA_LICENSE_KEY', 'nkyBQWh7E13uinDjzgnb9WqKShcwrqFe9TZvf61W1weZl6MIDw'),
    ...
    */
    ...
    'passwords' => env('NOVA_PASSWORDS', 'web'),
   ...
   'brand' => [
       //'logo' => asset('storage/bsmslogoblu1.svg'),
////            //'logo' => asset('http://bsms-web-pro01.brighton.ac.uk/var/www/placements.bsms.ac.uk/storage/app/public/bsmsLogoblu.svg'),
   ],
