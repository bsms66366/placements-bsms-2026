...
class Dicom extends Resource
{
     ...
     *
     * @var class-string<\App\Models\Dicom>
     */
    public static $model = \App\Models\Dicom::class;
    ...
    public function fields(NovaRequest $request)
    {
        ...
        File::make('DICOM Files', 'dicom_files')
            ->disk('public')
            ->store(function (Request $request, $model) {
                $directory = 'dicom';
                $originalFilename = $request->file('dicom_files')->getClientOriginalName();
                $path = $request->file('dicom_files')->storeAs($directory, $originalFilename, 'public');
