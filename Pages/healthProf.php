...
<body>
    <div class="container">
    		<div class="row">
                <div class="span12">
                  <center>
    			    <h3>Health Professions Notes</h3>
            </center>
                </div>
    		</div>
        <div class="span12">
			...
			<div class="row">
				...
				<table class="table table-bordered">
		              ...
		              <?php
                       ...
                       $filter .= "WHERE (name LIKE :query OR urlCode LIKE :query OR video LIKE :query) ";
                       $filter .= "AND category_id = 14; ";
                       ...
                       $sql = "SELECT urlCode, notes.name, notes.video, category.course ";
                        $sql .= $filter; 
                       //$sql .= "FROM notes " ;
                       //$sql .= "JOIN category ON notes.category_id = category.id ";
                       //$sql .= "WHERE (name LIKE :query OR urlCode LIKE :query) ";
